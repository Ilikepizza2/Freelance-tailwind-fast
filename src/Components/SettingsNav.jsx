...
const SettingsNav = () => {
  return (
    <div className='bg-white flex divide-gray-300 divide-x-[1px] w-fit rounded-lg mt-2 outline outline-1 outline-gray-300 text-gray-700 font-semibold text-sm max-w-full min-h-10'>
